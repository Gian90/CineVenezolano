...
<!-- Sistema de regillas Para el director de peliculas Del administrador para modificacion de datos-->
<div id="ModificarCampo" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="gridModalLabel" aria-hidden="true">
