...
<?php echo $this->Form->create('Referencia'); ?>
	<fieldset>
		<legend><?php echo __('Edit Referencia'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Referencia.REFERENCIA_ID')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('Referencia.REFERENCIA_ID'))); ?></li>
