...
<?php echo $this->Form->create('ReferenciasCrictica'); ?>
	<fieldset>
		<legend><?php echo __('Edit Referencias Crictica'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('ReferenciasCrictica.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('ReferenciasCrictica.id'))); ?></li>
