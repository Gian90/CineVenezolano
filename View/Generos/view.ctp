...
<h2><?php echo __('Genero'); ?></h2>
	<dl>
		...
		<dd>
			<?php echo h($genero['Genero']['GENERO_ID']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('GEN NOMBRE'); ?></dt>
		<dd>
			<?php echo h($genero['Genero']['GEN_NOMBRE']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('GEN MOSTRAR'); ?></dt>
		<dd>
			<?php echo h($genero['Genero']['GEN_MOSTRAR']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Genero'), array('action' => 'edit', $genero['Genero']['GENERO_ID'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Genero'), array('action' => 'delete', $genero['Genero']['GENERO_ID']), array(), __('Are you sure you want to delete # %s?', $genero['Genero']['GENERO_ID'])); ?> </li>
...
<div class="related">
	...
	<?php foreach ($genero['Pelicula'] as $pelicula): ?>
		<tr>
